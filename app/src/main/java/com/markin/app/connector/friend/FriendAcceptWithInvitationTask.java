 ...
 */
public class FriendAcceptWithInvitationTask extends AsyncTask<Void, Void, Boolean> {
    private String token;
    private String my_id;
    private String invitation_num;
    private OnTaskCompleted listener;

    public FriendAcceptWithInvitationTask(OnTaskCompleted listener, String my_id, String invitation_num, String token) {
        this.my_id = my_id;
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            ...
            response = restTemplate.exchange(RESTAPIManager.invitation_accept_url + my_id + "/" + invitation_num, HttpMethod.PUT, new HttpEntity(headers), Boolean.class);
