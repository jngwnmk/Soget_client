...
public class LikeTask extends AsyncTask<Void, Void, Integer> {
    ...
    public LikeTask(OnTaskCompleted listener,String user_id, String bookmark_id, String token ) {
    ...
    protected Integer doInBackground(Void... params) {
        try {
            ...
            ResponseEntity<Integer> response = restTemplate.exchange(RESTAPIManager.like_url + bookmark_id + "/" + user_id, HttpMethod.POST, new HttpEntity(headers), Integer.class);
